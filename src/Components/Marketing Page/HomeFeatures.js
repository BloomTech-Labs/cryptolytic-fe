        ...
        <div className={classes.homeFeatureContainer}>
            <div style={{ paddingTop: '30vh' }}>
                ...
                if(e.reverse) {
                    ...
                    return (
                    <div className={classes.homeFeatureRow} style={{ flexDirection: reverse.row }}>
                        <div className={classes.homeFeatureRowImage} style={{ justifyContent: reverse.leftJustify }}>
                            <img src={e.image} />
                        </div>
                        <div className={classes.homeFeatureRowText} style={{ justifyContent: reverse.rightJustify, textAlign: reverse.textAlign }}>
                            <div>
            ...
            <div className={classes.homeFeatureLastRow}>
                <div className={classes.homeFeatureLastRowText}>
                    <div>
                        <h2 className={classes.homeFeatureLastRowTitle}>Automate your trading process</h2>
                        <p className={classes.homeFeatureLastRowSubtitle}>The cryptocurrency market doesn’t sleep and neither should your money! Connect the Cryptolytic API to a trading bot and act on trading and arbitrage opportunities automatically 24/7!</p>
                    </div>
                </div>
